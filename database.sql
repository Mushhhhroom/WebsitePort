...
INSERT INTO `resume` (`id`, `section`, `title`, `subtitle`, `date_range`, `content`, `display_order`) VALUES
...
(2, 'education', 'Senior High School — ICT Strand | With Honors, Grade 11', 'Young Achievers\' School of Caloocan INC.', 'S.Y 2020 - 2023', 'Information and Communications Technology (ICT) strand. Graduated with academic honors in Grade 11, developing core foundations in programming and computer systems.', 2),
(3, 'education', 'High School', 'Deparo High School, Caloocan City', 'S.Y 2016 - 2020', 'Completed secondary junior high school education with strong foundational academic background.', 3),
(4, 'experience', 'Junior Philippine Computer Society — QCU Chapter', 'Board of Programmer Officer', 'Active', '• Supported programming-related activities and student organization initiatives.\n• Collaborated with fellow officers to coordinate technical projects and events.\n• Helped promote programming and technology activities among Computer Science students.', 1),
(5, 'skills', 'Development', 'Core Development Roles', 'Proficient', 'Website, Application and Mobile Developer', 1),
(6, 'skills', 'Databases', 'Relational & NoSQL Stores', 'Advanced', 'MySQL, MongoDB, PostgreSQL, Supabase', 2),
(7, 'skills', 'Networking', 'Infrastructure & Systems', 'Technical', 'Network Troubleshooting, Cisco Router Configuration', 3),
(8, 'skills', 'Soft Skills', 'Professional Competencies', 'Key Strengths', 'Communication, Critical Thinking, Problem-Solving, Teamwork', 4),
(9, 'certifications', 'AWS Cloud Engineering Seminar', 'JPCS QCU Chapter', '2024', 'Exploration of cloud architecture, scalable engineering, and AWS cloud ecosystem fundamentals.', 1),
(10, 'certifications', 'Data Visualization Workshop', 'Zuitt', '2025', 'Hands-on workshop covering modern data visualization patterns, chart architectures, and data storytelling.', 2),
(11, 'certifications', 'IT Summit', 'Industry Conference', '2025', 'Attended sessions on emerging technologies, enterprise systems, and the future of computing.', 3),
(12, 'certifications', 'GLOBE x JPCS: Innovania', 'Innovation Summit & Workshop', '2025', 'Participated in collaborative technology innovation, problem-solving workshops, and digital transformation discussions.', 4);

-- Insert Accurate Projects Data
TRUNCATE TABLE `projects`;
INSERT INTO `projects` (`id`, `title`, `description`, `tech_stack`, `category`, `github_link`, `demo_link`, `featured`) VALUES
